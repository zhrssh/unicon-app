...
import 'provider_fillup.dart';
import 'package:http/http.dart' as http;

void main() {
  runApp(const MaterialApp(
    home: ProviderVerifyPage(uuid: ""),
    debugShowCheckedModeBanner: false,
  ));
}

class ProviderVerifyPage extends StatefulWidget {
  final String uuid;
  const ProviderVerifyPage({super.key, required this.uuid});

  @override
  State<ProviderVerifyPage> createState() => _ProviderVerifyPageState(uuid);
}

class _ProviderVerifyPageState extends State<ProviderVerifyPage> {
  final String _uuid;
  _ProviderVerifyPageState(this._uuid);
            ...
            children: [
              ...
              Column(
                ...
                children: const [
                  ...
                  Text(
                    "the business email you registered.",
                    style: TextStyle(color: Colors.white),
                  ),
                ],
              ),
