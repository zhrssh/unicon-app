...
//Rendon Labador
class WorkerProfilePage3 extends StatefulWidget {
  const WorkerProfilePage3({super.key});

  @override
  State<WorkerProfilePage3> createState() => _WorkerProfilePage3State();
}

class _WorkerProfilePage3State extends State<WorkerProfilePage3>
                ...
                ListView(
                  children: [
                    ...
                    _buildProjects(
                        ...
                        title: 'House and Lot Planning and Design',
                        date: 'November 2020'.toUpperCase())
                  ],
                ),
                ListView(
                  children: [
