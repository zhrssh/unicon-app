...
import 'package:untitled/views/company/company_confirmfill.dart';
...
void main() {
  runApp(const MaterialApp(
    home: CompanyVerify(uuid: ""),
    debugShowCheckedModeBanner: false,
  ));
}

class CompanyVerify extends StatefulWidget {
  final String uuid;
  const CompanyVerify({super.key, required this.uuid});

  @override
  State<CompanyVerify> createState() => _CompanyVerifyState(uuid);
}

class _CompanyVerifyState extends State<CompanyVerify> {
  final String _uuid;
  _CompanyVerifyState(this._uuid);
